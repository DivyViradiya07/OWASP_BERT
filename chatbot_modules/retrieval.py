...
class RetrievalManager:
    ...
    async def _rewrite_query(self, query: str) -> str:
        ...
        try:
            ...
            rewritten_query = await generate_llm_response(self.components.llm, prompt, max_tokens=100, temperature=0.3)
    ...
    async def _summarize_context(self, context_text: str, question: str) -> str:
        ...
        try:
            ...
            summary = await generate_llm_response(self.components.llm, prompt, max_tokens=CONFIG["MAX_CONTEXT_TOKENS"] // 2, temperature=0.4)
            return summary
        except Exception as e:
